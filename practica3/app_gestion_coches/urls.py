...
from .views import (
    ...
    buscar_cliente, buscar_coche_por_matricula, buscar_coches_de_cliente, buscar_servicios_de_coche
)
...
urlpatterns = [
    ...
    path('servicios/todos/', listar_servicios_taller, name='listar_servicios_taller'),
